...
public class CalendarInsideMain extends JFrame {

    public CalendarInsideMain() {
            ...
            for (int d=1; d<=days; d++) {
                ...
                if (enabled) {
                    btn.addActionListener(e ->
                            JOptionPane.showMessageDialog(this, "Selected: " + date));
                }
                grid.add(btn);
            }
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new CalendarInsideMain().setVisible(true));
    }
}
